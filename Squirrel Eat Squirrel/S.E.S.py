...
def main():
    ...
    pygame.display.set_icon(pygame.image.load(r'D:/VS_Workspace/Python/Pygame/Squirrel Eat Squirrel/gameicon.png'))
    DISPLAYSURF = pygame.display.set_mode((WINWIDTH, WINHEIGHT))
    pygame.display.set_caption('Squirrel Eat Squirrel')
    BASICFONT = pygame.font.Font('freesansbold.ttf', 32)

    # load the image files
    L_SQUIR_IMG = pygame.image.load(r'D:/VS_Workspace/Python/Pygame/Squirrel Eat Squirrel/squirrel.png')
    R_SQUIR_IMG = pygame.transform.flip(L_SQUIR_IMG, True, False)
    GRASSIMAGES = []
    for i in range(1, 5):
        GRASSIMAGES.append(pygame.image.load(r'D:/VS_Workspace/Python/Pygame/Squirrel Eat Squirrel/grass%s.png' % i))
